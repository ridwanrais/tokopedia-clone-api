...
const AuthenticationsCollectionTestHelper = require("../../../../tests/AuthenticationsCollectionTestHelper");
...
describe("/authentications endpoint", () => {
  ...
  describe("when DELETE /authentications", () => {
    it("should response 200 if refresh token valid", async () => {
      ...
      const token = await AuthenticationsCollectionTestHelper.getAuthModel(
        refreshToken
      );
      await db.collection("authentications").insertOne(token);
